...
#         'NAME': os.getenv('DB_NAME', 'video_platform'),
...
FILE_UPLOAD_MAX_MEMORY_SIZE = 3221225472  # 3 GB
DATA_UPLOAD_MAX_MEMORY_SIZE = 3221225472  # 3 GB

# Video Upload Settings
MAX_VIDEO_SIZE = 3 * 1024 * 1024 * 1024  # 3 GB in bytes
